...
function StoryTelling() {
    ...
    const BASE_PROMPT_TEXT = 'I want you to act as a car salesman. My first request is "sell the best Audi model to a '
    const PROMPT_DETAILS = ' Provide details about the best models, features and also the advantages comparing with competitors on the same category'
    //const BASE_PROMPT_TEXT = 'can you write a text to sell an audi car to a person with the profile '
    
    const SOCCER_MON_PROMPT = BASE_PROMPT_TEXT + "soccer mon woman?" + PROMPT_DETAILS
    const ADV_PROMPT = BASE_PROMPT_TEXT + " person that likes adventure like tracking, cycling and fishing?" + PROMPT_DETAILS
    const PILOT_PROMPT = BASE_PROMPT_TEXT + " person that loves race cars?" + PROMPT_DETAILS
    ...
    useEffect(() => {
        ...
        const buttonSoccer = document.querySelector('#btn-soccer-mon')
        const buttonAdv = document.querySelector('#btn-adv')
        const buttonPilot = document.querySelector('#btn-pilot')
        ...
        const compareSubmit = async (MODE) => {
        ...
        const handleSubmit = async (e) => {
            ...
            if (compareCarMode==="SOCCER_MON") {
                promptData = SOCCER_MON_PROMPT
                compareCarMode = false
            }
            else if (compareCarMode==="PILOT") {
                promptData = PILOT_PROMPT
                compareCarMode = false
            }
            else if (compareCarMode==="ADV") {
                promptData = ADV_PROMPT
                compareCarMode = false
            }
            else {
        ...
        buttonSoccer.addEventListener('click', () => compareSubmit("SOCCER_MON"));
        buttonAdv.addEventListener('click', () => compareSubmit("ADV"))
        buttonPilot.addEventListener('click', () => compareSubmit("PILOT"))
            ...
            <div id="app">
                    ...
                    <Card >
                        ...
                        {/*  <a href={`https://www.youtube.com/watch?v=${id.videoId}`}>Watch</a> */}
                            ...
                            <Button size="medium" id="btn-soccer-mon" endIcon={<SendIcon />} >Tell me a story</Button>
                            </CardActions>
                    </Card>
                    <Card >
                        <CardMedia
                    ...
                    {/*  <a href={`https://www.youtube.com/watch?v=${id.videoId}`}>Watch</a> */}
                        {/* <Button size="small">Share</Button> */}
                        <Button size="medium" id="btn-adv" endIcon={<SendIcon />} >Tell me a story</Button>
                        </CardActions>
                    </Card>
                    <Card >
                        <CardMedia
                    ...
                    {/*  <a href={`https://www.youtube.com/watch?v=${id.videoId}`}>Watch</a> */}
                        {/* <Button size="small">Share</Button> */}
                        <Button size="medium" id="btn-pilot" endIcon={<SendIcon />} >Tell me a story</Button>
                        </CardActions>
                    </Card>
                   ...
                   {/*      <Button size="medium" variant="contained" endIcon={<SendIcon />} onClick={compareSubmit} >Compare</Button> */}
                       {/*  <button className='button' endIcon={<SendIcon />}>Create Story Telling</button> */}
                        <div id="chat_container"></div>
                        <span className="text-headline" >Improve your story telling by asking me more details:</span>
                        <form>
